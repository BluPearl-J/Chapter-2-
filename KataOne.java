...
public static void main(String[] args) {
System.out.println("Division of 1 and 10 is " + divide(1, 10));
System.out.println("Division of20 and 37 is " + divide(20, 37));
System.out.println("Division of35 and 49 is " + divide(35, 49));
}
}
